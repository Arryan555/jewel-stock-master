...
const NAV_ITEMS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Retail Sale", href: "/billing/retail/new", icon: Receipt },
      { name: "Wholesale", href: "/billing/wholesale/new", icon: FileSpreadsheet },
      { name: "Gold Bill", href: "/billing/gold/new", icon: ShoppingBag },
      { name: "Diamond Bill", href: "/billing/diamond/new", icon: Diamond },
      { name: "Exchange", href: "/billing/exchange/new", icon: ArrowLeftRight },
      { name: "Repair Bill", href: "/billing/repair/new", icon: Wrench },
